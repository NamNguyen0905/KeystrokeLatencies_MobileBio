...
def get_landmarks(images, labels, save_directory="", num_coords=5, to_save=False):
    ...
    for img, label in zip(images, labels):
        ...
        for d in detected_faces:
            ...
            # Get distances of feature fusion
            landmarks.append(EuclideanDist(points) + ManhattanDist(points))
    ...
    print('Image detected : %d / %d. (%.1f percent)' %
          (count, len(images), percentage))
    print("Time for get_landmarks: --- %.2f minutes ---" %
